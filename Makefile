...
SOURCES = \
	__init__.py \
	recLayerAdd.py recLayerAdd_dialog.py

PLUGINNAME = recLayerAdd

PY_FILES = \
	__init__.py \
	recLayerAdd.py recLayerAdd_dialog.py

UI_FILES = recLayerAdd_dialog_base.ui
...
QGISDIR=C:\Users\skipper-terrain\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
